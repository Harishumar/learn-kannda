const Numbers = () => {
    ...
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೦</i>
       ...
       <br/><i className="material-icons right">sonne (ಸೊನ್ನೆ)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೧</i>
       ...
       <br/><i className="material-icons right">ondu (ಒಂದು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೨	</i>
       ...
       <br/><i className="material-icons right">eraḍu (ಎರಡು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೩</i>
       ...
       <br/><i className="material-icons right">mūru (ಮೂರು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೪</i>
       ...
       <br/><i className="material-icons right">nālku (ನಾಲ್ಕು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೫</i>
       ...
       <br/><i className="material-icons right">aidu (ಐದು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೬</i>
       ...
       <br/><i className="material-icons right">āru (ಆರು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೭</i>
       ...
       <br/><i className="material-icons right">ēḷu (ಏಳು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೮</i>
       ...
       <br/><i className="material-icons right">enṭu (ಎಂಟು)</i></span> 
      </div>
    </div>
  </div>
  <div className="row" >
    <div className="col s8 m1">
      ...
      <span className="white-text"><i className="material-icons right">೯</i>
       ...
       <br/><i className="material-icons right">oṃbattu (ಒಂಬತ್ತು)	</i></span> 
      </div>
    </div>
  </div>
